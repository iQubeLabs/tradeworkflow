...
--
ALTER TABLE  `ports` DROP FOREIGN KEY  `country_id`
...
INSERT INTO `countries` (`id`, `name`, `iso_alpha2`, `code`, `iso_numeric`, `currency_code`, `currency_name`, `currrency_symbol`, `flag`) VALUES
...
ALTER TABLE  `ports` ADD CONSTRAINT  `country_id` FOREIGN KEY (  `country_id` ) REFERENCES  `tradeworkflow`.`countries` (
`id`
