<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><?php echo $this->Html->link("Demurrage Tracking", array("action"=>"index"));?></li>
    </ol>
</section>
            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Shipping Line</th>
                        <th>Form M Name</th>                        
                        <th>Demurrage Days left</th>
                        <th>Cost incurred per day</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    foreach ($clearings as $clearing)
                    {
                        ...
                        echo "<td>".$this->MyDate->dayAgo(strtotime($clearing['Shipping']['demurrage_last_day']))."</td>";
                        echo "<td>";
                        echo $clearing['Shipping']['demurrage_cost_per_day'];
                        echo "</td>";
                        echo "<td>";
