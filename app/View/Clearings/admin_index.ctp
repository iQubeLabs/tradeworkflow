            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    foreach ($clearings as $clearing)
                    {
                        ...
                        echo "</td>";
                        echo "<td>";
                        echo $this->Html->link("View Details", array("controller"=>"clearings", "action"=>"view", $clearing["Shipping"]["id"]), array("class"=>"btn btn-xs btn-primary btn-block", 
                                  "id" => "clearBtn".$clearing["Shipping"]["id"]));
                        
                        if($clearing["Shipping"]["is_cleared"] == "0")
                        {
                            echo $this->Html->link("Notify Trader to clear", "#", array("class"=>"btn btn-xs btn-success btn-block", 
                                  "id" => "clearBtn".$clearing["Shipping"]["id"]));
                        }
                        echo "</td>";
                        echo "</tr>";
