    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="customers index">
                ...
                <tr>
                        ...
                        <td><?php echo h(Customer::$ENUM_STATUS[$customer['Customer']['status']]); ?>&nbsp;</td>
                        <td><?php echo h($customer['Customer']['email']); ?>&nbsp;</td>
                        <td><?php echo h($this->MyDate->dateTimeToDate($customer['Customer']['created'])); ?>&nbsp;</td>
                        <td class="actions">
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Trader'), array('action' => 'add')); ?></li>
