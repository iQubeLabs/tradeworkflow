...
<html>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="<?php echo Router::url(array("controller"=>"dashboard", "action" => "index"));?>" class="logo">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        <?php echo $this->get("User.email");?>
                                        <br/>
                                        <?php echo $this->get("User.phone");?>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <?php echo $this->Html->link("Sign out", array("controller"=>"dashboard", "action" => "signout", "dashboard"=> true), array("class" => "btn btn-default btn-flat"));?>
                                    </div>
                                </li>
                            </ul>
                        </li>
                ...
                <section class="sidebar">
                    ...
                    <form action="#" method="get" class="sidebar-form">
                        <div class="input-group">
                            <input type="text" name="q" class="form-control" placeholder="Search for Form M"/>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo $this->get("Nav.Trade"); ?>">                            
                            <a href="<?php echo Router::url(array("controller"=>"trades", "action"=>"index"));?>">
                                <i class="fa fa-compress"></i> <span>Manage Shipments</span>
                            </a>
                        </li>
